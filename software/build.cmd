...
del build\apps\dmg_emu\CMakeFiles\dmg_emu.dir\main.c.obj.d
...
if exist apps\dmg_emu\dmg_emu.elf (
    echo Binary size:
    dir build\apps\dmg_emu\dmg_emu.elf | find "dmg_emu.elf"
)

if exist %DRIVE_LETTER%\ (
    echo.
    echo ===== Copying UF2 to %DRIVE_LETTER%\ =====
    copy /y build\apps\dmg_emu\dmg_emu.uf2 %DRIVE_LETTER%\ >nul
    if %errorlevel% neq 0 (
        echo *** COPY FAILED ***
        goto :build_fail
    )
